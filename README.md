...
- **Stats UI**: The session view includes a button to reveal a stats panel that summarizes attempts/accuracy for the current pack, daily activity for the last 14 days, and per-item progress.
