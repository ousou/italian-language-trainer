...
- [x] Build new history page UI (all packs + per-pack) with download/upload/merge/overwrite flows and update styles.
- [x] Run required tests/build/e2e, update snapshots/docs/spec, commit per checklist item.
