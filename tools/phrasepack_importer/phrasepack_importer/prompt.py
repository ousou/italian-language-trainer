...
def build_pairs_to_items_prompt(src_lang: str, dst_lang: str) -> str:
    ...
    return (
        ...
        "- If you split an Italian entry into multiple items, you must also make dst unambiguous.\n"
        "  Example: 'italiano, italiana' with dst 'italialainen (mies, nainen)' ->\n"
        "  dst 'italialainen (mies)' for italiano, and 'italialainen (nainen)' for italiana.\n"
        "  If you can't make dst unambiguous, omit the entry.\n"
